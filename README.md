...
A Java console-based program for managing student records using **File Handling**, **Collections**, **Searching**, **Sorting**, and **Iterators**.
This project implements all required operations in a single Java file for simplicity.
...
4. A file named **students.txt** will be created automatically.
